# Travel Bot
Making it easy for friends to share travel plans and recommendations.

# Based on Facebook Chat Extensions (Tasks)
This project extends Tasks, a bot that demonstrates [Chat Extensions](https://developers.facebook.com/docs/messenger-platform/design-best-practices/guides/chat-extensions) on the Messenger Platform.
...
$ createdb travel_bot_dev
$ createdb travel_bot_test
$ yarn install
$ knex migrate:latest
$ knex seed:run
$ yarn build:watch
